...
// Config directory: ~/.connect/huggingface/
...
// ============================================
// API Key Management
// Supports both HUGGINGFACE_API_KEY and HF_TOKEN env vars
// ============================================

export function getApiKey(): string | undefined {
  return process.env.HUGGINGFACE_API_KEY || process.env.HF_TOKEN || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.HUGGINGFACE_API_SECRET || loadProfile().apiSecret;
}
