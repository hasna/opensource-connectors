...
export function getAccountId(): string | undefined {
  return process.env.ZOOM_ACCOUNT_ID || loadProfile().accountId;
}
...
export function getClientId(): string | undefined {
  return process.env.ZOOM_CLIENT_ID || loadProfile().clientId;
}
...
export function getClientSecret(): string | undefined {
  return process.env.ZOOM_CLIENT_SECRET || loadProfile().clientSecret;
}
...
export function setTokenExpiry(tokenExpiry: number): void {
  const config = loadProfile();
