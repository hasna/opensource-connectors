...
// ============================================
// API Key Management
// E2B uses E2B_API_KEY environment variable
// ============================================

export function getApiKey(): string | undefined {
  return process.env.E2B_API_KEY || loadProfile().apiKey;
}
...
export function getBaseUrl(): string | undefined {
  return process.env.E2B_BASE_URL || loadProfile().baseUrl;
}
...
export function getDefaultTemplate(): string | undefined {
  return loadProfile().defaultTemplate;
}

export function setDefaultTemplate(template: string): void {
  const config = loadProfile();
  config.defaultTemplate = template;
  saveProfile(config);
}

export function getDefaultTimeout(): number | undefined {
  return loadProfile().defaultTimeout;
}
