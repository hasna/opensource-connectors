...
const CONNECTOR_NAME = 'connect-hedra';
...
// ============================================
// API Key Management
// Environment variable: HEDRA_API_KEY
// ============================================

export function getApiKey(): string | undefined {
  return process.env.HEDRA_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.HEDRA_API_SECRET || loadProfile().apiSecret;
}
