...
export interface ProfileConfig {
  apiKey?: string;
  apiSecret?: string;
  // Add more config fields as needed for Sentry
}
...
// ============================================
// API Key Management
// Sentry uses auth tokens (SENTRY_AUTH_TOKEN) or API keys (SENTRY_API_KEY)
// ============================================

export function getApiKey(): string | undefined {
  return process.env.SENTRY_AUTH_TOKEN || process.env.SENTRY_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.SENTRY_API_SECRET || loadProfile().apiSecret;
}
