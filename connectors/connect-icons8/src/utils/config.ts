...
// Icons8 connector configuration
const CONNECTOR_NAME = 'connect-icons8';
...
// ============================================
// API Key Management
// Icons8 uses ICONS8_API_KEY environment variable
// ============================================

export function getApiKey(): string | undefined {
  return process.env.ICONS8_API_KEY || loadProfile().apiKey;
}
...
export function getApiSecret(): string | undefined {
  return process.env.ICONS8_API_SECRET || loadProfile().apiSecret;
}
