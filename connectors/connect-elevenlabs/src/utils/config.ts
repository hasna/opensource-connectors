...
// Config directory: ~/.connect/connect-elevenlabs/
...
export function getApiKey(): string | undefined {
  return process.env.ELEVENLABS_API_KEY || process.env.XI_API_KEY || loadProfile().apiKey;
}
...
export function getDefaultVoiceId(): string | undefined {
  return process.env.ELEVENLABS_VOICE_ID || loadProfile().defaultVoiceId;
}
...
export function getDefaultModel(): string | undefined {
  return process.env.ELEVENLABS_MODEL_ID || loadProfile().defaultModel;
}
...
export function getOutputDir(): string {
  return process.env.ELEVENLABS_OUTPUT_DIR || loadProfile().outputDir || process.cwd();
}
