...
// Store config in ~/.connect/connect-stabilityai/ (always in home directory)
...
export function createProfile(profile: string, config: ProfileConfig = {}): boolean {
  ...
  // Create exports and imports subdirectories
...
export function getApiKey(): string | undefined {
  return process.env.STABILITY_API_KEY || loadProfile().apiKey;
}
