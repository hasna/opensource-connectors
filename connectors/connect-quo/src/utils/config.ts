...
// Config directory: ~/.connect/connect-quo/
 ...
 */
export function getProfileDir2(profile?: string): string {
  const profileName = profile || getCurrentProfile();
  return getProfileDir(profileName);
}

/**
 * Get exports directory path for profile
 */
...
/**
 * Get imports directory path for profile
 */
...
export function getApiKey(): string | undefined {
  return process.env.QUO_API_KEY || loadProfile().apiKey;
}
