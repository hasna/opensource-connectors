...
export function getApiKey(): string | undefined {
  return process.env.OPENAI_API_KEY || loadProfile().apiKey;
}
...
export function getOrganization(): string | undefined {
  return process.env.OPENAI_ORGANIZATION || loadProfile().organization;
}

export function setOrganization(organization: string): void {
  const config = loadProfile();
