...
export function getBotToken(): string | undefined {
  return process.env.DISCORD_BOT_TOKEN || process.env.DISCORD_TOKEN || loadProfile().botToken;
}

export function setBotToken(botToken: string): void {
...
export function getApplicationId(): string | undefined {
  return process.env.DISCORD_APPLICATION_ID || loadProfile().applicationId;
}
...
export function getDefaultGuildId(): string | undefined {
  return process.env.DISCORD_GUILD_ID || loadProfile().defaultGuildId;
}

export function setDefaultGuildId(guildId: string): void {
  const config = loadProfile();
  config.defaultGuildId = guildId;
  saveProfile(config);
}
