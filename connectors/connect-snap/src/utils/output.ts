...
/**
 * Format micro-currency (1/1,000,000) to display currency
 */
export function formatMicroCurrency(microAmount: number, currency: string = 'USD'): string {
...
/**
 * Parse display currency to micro-currency
 */
export function parseMicroCurrency(displayAmount: number): number {
