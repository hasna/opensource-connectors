...
// ============================================
// Wix Credentials Management
// ============================================

export function getApiKey(): string | undefined {
  return process.env.WIX_API_KEY || loadProfile().apiKey;
}
...
export function getSiteId(): string | undefined {
  return process.env.WIX_SITE_ID || loadProfile().siteId;
}
...
export function getAccountId(): string | undefined {
  return process.env.WIX_ACCOUNT_ID || loadProfile().accountId;
}
